...
const { getProductDetail } = require("../controllers/digital_product_controllers/get_detail_product.controller");


const productRouter = Router();

productRouter.get("/digital-product", getAllProducts);
productRouter.get("/digital-product/:id", getProductDetail);
